...
The key lesson from this issue is:
...
If Windows Event Log is unavailable, an analyst cannot safely conclude that no PowerShell or system activity occurred.

The correct conclusion is:

```text
Required telemetry source was temporarily unavailable.
```

This distinction is important in SOC investigations because missing telemetry can affect confidence in a finding.
